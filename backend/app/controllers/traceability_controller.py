...
class TraceabilityController:
    ...
    def get_medical_records():
        ...
        try:
            ...
            print(f"🔍 Filtros: patient_id={patient_id}, doctor_id={doctor_id}")
            
            records = TraceabilityService.get_medical_records(patient_id, doctor_id)
            print(f"📊 Registros médicos encontrados: {len(records)}")
            
            # CORRECCIÓN: records ya es una lista de diccionarios, no necesita to_dict()
    ...
    def get_medical_record(record_id):
        ...
        try:
            ...
            # record ya es un diccionario, no necesita to_dict()
    ...
    def create_medical_record():
        ...
        try:
            ...
            print(f"✅ Registro médico creado: ID {record.id}")
            
            # record es un objeto MedicalRecord, SÍ necesita to_dict()
            return jsonify({
    ...
    def add_prescription(record_id):
        ...
        try:
            ...
            print(f"✅ Prescripción añadida exitosamente")
            
            # prescription es un objeto Prescription, SÍ necesita to_dict()
            return jsonify({
